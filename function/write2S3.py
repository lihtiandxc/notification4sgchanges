...
def put_list_to_s3(r, file):
    #print(r)
    obj = s3res.Object('limliht-config','config/'+aws_region+'/'+file)
...
if __name__ == "__main__":
    # try:
        ...
        ec2_default_document = 'ec2_default_document.json'
        asg_default_document = 'asg_default_document.json'
        result_ec2 = get_account_ec2_list()
        result_asg = get_account_asg_list()
        print(result_ec2)
        print(result_asg)
        put_list_to_s3(result_ec2, ec2_default_document)
        put_list_to_s3(result_asg, asg_default_document)
